...
#[cfg(feature = "git2")] pub const GIT_CLEAN_BG: u8 = 148;
#[cfg(feature = "git2")] pub const GIT_CLEAN_FG: u8 = 0;
#[cfg(feature = "git2")] pub const GIT_DIRTY_BG: u8 = 161;
#[cfg(feature = "git2")] pub const GIT_DIRTY_FG: u8 = 15;
#[cfg(feature = "git2")] pub const GIT_AHEAD_BG:  u8 = 240;
#[cfg(feature = "git2")] pub const GIT_AHEAD_FG:  u8 = 250;
#[cfg(feature = "git2")] pub const GIT_BEHIND_BG: u8 = 240;
#[cfg(feature = "git2")] pub const GIT_BEHIND_FG: u8 = 250;
#[cfg(feature = "git2")] pub const GIT_CONFLICTED_BG: u8 = 9;
#[cfg(feature = "git2")] pub const GIT_CONFLICTED_FG: u8 = 15;
#[cfg(feature = "git2")] pub const GIT_NOTSTAGED_BG: u8 = 130;
#[cfg(feature = "git2")] pub const GIT_NOTSTAGED_FG: u8 = 15;
#[cfg(feature = "git2")] pub const GIT_STAGED_BG:    u8 = 22;
#[cfg(feature = "git2")] pub const GIT_STAGED_FG:    u8 = 15;
#[cfg(feature = "git2")] pub const GIT_UNTRACKED_BG: u8 = 52;
#[cfg(feature = "git2")] pub const GIT_UNTRACKED_FG: u8 = 15;
